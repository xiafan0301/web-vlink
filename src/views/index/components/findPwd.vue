<template>
  <div class="vl_pwd">
    ...
    <div class="pwd_main">
      <div class="pwd_t">
        <div class="pwd_ts_1" :class="{'pwd_ts_sed': step === 1}">
          <i>1</i>确认账号
        </div>
      ...
      <ul class="pwd_ul">
          ...
          <div>
            ...
            <el-form :model="pwdForm1" status-icon :rules="pwdForm1Rules" ref="pwdForm1">
              <el-form-item prop="mobile">
                <el-input
                  type="text"
                  v-model="pwdForm1.mobile"
                  autocomplete="off"
                  placeholder="输入手机号"
                ></el-input>
              </el-form-item>
              <el-form-item>z向右滑动验证</el-form-item>
              <el-form-item>
                <el-button
                  type="primary"
                  :disabled="!pwdForm1.mobile"
                  :loading="pwdForm1Loading"
                  @click="nextStep1('pwdForm1')"
                >下一步</el-button>
              </el-form-item>
            </el-form>
          </div>
        ...
        <li v-show="step === 2">
          <div>
            ...
            <p class="pwd_mobile_p">手机号：
              <span>{{pwdForm1.mobile | mobileSecurity}}</span>
            </p>
            <el-form :model="pwdForm2" status-icon :rules="pwdForm2Rules" ref="pwdForm2">
              <el-form-item prop="code">
                <el-input
                  style="width: 200px;"
                  type="text"
                  v-model="pwdForm2.code"
                  autocomplete="off"
                  :maxlength="16"
                  placeholder="请输入验证码"
                ></el-input>
                <el-button
                  @click="getRegCode('pwdForm2')"
                  :disabled="regCodeDis"
                  class="pwd_code_btn"
                >{{regCodeTip}}</el-button>
              </el-form-item>
              <el-form-item>
                <el-button
                  type="primary"
                  :disabled="!pwdForm2.code"
                  :loading="pwdForm2Loading"
                  @click="nextStep2('pwdForm2')"
                >下一步</el-button>
              </el-form-item>
            </el-form>
          </div>
          ...
          <div>
            ...
            <el-form :model="pwdForm3" status-icon :rules="pwdForm3Rules" ref="pwdForm3">
              ...
              <el-form-item>
                <el-button
                  type="primary"
                  :disabled="!pwdForm3.pass || !pwdForm3.checkPass"
                  :loading="pwdForm3Loading"
                  @click="nextStep3('pwdForm3')"
                >下一步</el-button>
              </el-form-item>
            </el-form>
          </div>
