  ...
  <div class="set_list">
    ...
    <div class="member_title">
      ...
      <div>
        ...
        <el-button @click="judgeIsSelectedRemove" class="reset_btn btn_100">删除人像</el-button>
    ...
    <div class="del_portrait_dialog">
      <el-dialog
        ...
        <div slot="footer">
          <el-button @click="delPortraitDialog = false" class="reset_btn btn_140">取消</el-button>
          <el-button :loading="loadingBtn" class="select_btn btn_140" @click="delPortrait">确认</el-button>
        </div>
      </el-dialog>
    </div>
  </div>
