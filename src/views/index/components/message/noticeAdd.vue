  ...
  <div class="mes_notice_add">
    ...
    <div class="notice_add_box">
      ...
      <div class="add_footer">
        <!-- 新增 -->
        <el-button :loading="loadingBtn" class="btn_100" type="primary" v-if="pageType === 2" @click="addMsgNote('addForm', 2)">发布</el-button>
        <el-button :loading="loadingBtn" class="btn_100" type="primary" v-if="pageType === 2" @click="addMsgNote('addForm', 1)">保存</el-button>
        <!-- 修改 -->
        <el-button :loading="loadingBtn" class="btn_100" type="primary" v-if="pageType === 4" @click="putMsgNote('addForm', 2)">发布</el-button>
        <el-button :loading="loadingBtn" class="btn_100" type="primary" v-if="pageType === 4" @click="putMsgNote('addForm', 1)">保存</el-button>
