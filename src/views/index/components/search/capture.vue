            ...
            <div class="vl_jfo_event_box clearfix">
              <div class="vl_jfo_box_item" v-for="(item, index) in strucInfoList" :key="item.id" @click="showStrucInfo(item, index)">
                ...
                <div class="vl_jfo_i_right">
                  <p>检索资料</p>
                  <div class="vl_jfo_line" :title="item.structuredTime"><i class="vl_icon vl_icon_retrieval_01"></i>{{item.structuredTime}}</div>
    ...
    <el-dialog
      ...
      <div class="struc_main">
        <div v-show="strucCurTab === 1" class="struc_c_detail">
          ...
          <div class="struc_c_d_box">
            ...
            <div class="struc_c_d_info">
              ...
              <div class="struc_cdi_line">
                <span>{{sturcDetail.structuredTime}}<i class="vl_icon vl_icon_retrieval_02"></i></span>
              </div>
              <div class="struc_cdi_line">
        ...
        <div v-show="strucCurTab === 3" class="struc_c_detail struc_c_video">
          ...
          <div class="download_btn">下载视频</div>
        </div>
      </div>
