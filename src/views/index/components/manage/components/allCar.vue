  ...
  <div class="set_list">
    ...
    <div class="member_title">
      ...
      <div>
        ...
        <el-button @click="judgeIsSelectedRemove" class="btn_100">删除车像</el-button>
    ...
    <div class="del_car_dialog">
      <el-dialog
        ...
        <div slot="footer">
          ...
          <el-button :loading="loadingBtn" class="btn_140" type="primary" @click="delVehicle">确认</el-button>
        </div>
      </el-dialog>
    </div>
  </div>
...
export default {
  ...
  props: ['carMemberList', 'tabType', 'currentPage', 'loading'],
  data () {
    return {
      allChecked: false,
      memberList: [],//成员列表数据
