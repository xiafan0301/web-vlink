      ...
      <div class="content-body">
        <el-form :model="editCar" :rules="rules" ref="editCar" label-width="90px">
          <el-form-item label="车牌号码:" prop="vehicleNo">
            <span>{{editCar.vehicleNo}}</span>
          </el-form-item>
          <el-form-item label="车辆编号:" prop="vehicleNum">
            <el-input style="width: 40%;" placeholder="请输入车辆编号" v-model="editCar.vehicleNum"></el-input>
          </el-form-item>
          <el-form-item label="识别代码:" prop="identCode">
            <el-input style="width: 40%;" placeholder="请输入识别代码" v-model="editCar.identCode"></el-input>
          </el-form-item>
          ...
          <el-form-item label="核载人数:" prop="personNum">
            <el-input style="width: 40%;" placeholder="请输入核载人数" v-model="editCar.personNum"></el-input>
          </el-form-item>
          ...
          <el-form-item label="号牌种类:" prop="numKind">
            <el-select style="width: 40%;" v-model="editCar.numKind" placeholder="请选择号牌种类">
              <!-- <el-option
                v-for="(item, index) in departmentData"
                :key="index"
                :label="item.organName"
          ...
          <el-form-item label="访问密码:" prop="password">
            <el-input style="width: 40%;" placeholder="请输入访问密码" v-model="editCar.password"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </div>
