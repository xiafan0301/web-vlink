    ...
    <div class="detail_box">
      ...
      <div class="basic_info">
        ...
        <ul>
          ...
          <li>
            <div><span>卡口编码</span><span>21</span></div>
            <div><span>卡口用途</span><span>车辆违章抓拍卡口</span></div>
          </li>
          <li>
            <div><span>所属机构</span><span>想县交通队</span></div>
            <div><span>描述</span><span>无</span></div>
          </li>
          <li>
        ...
        <el-table
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <span class="operation_btn" @click="toViewMonitor(scope.row)">查看监控</span>
            </template>
          </el-table-column>
      ...
      <div class="operate_btn">
        ...
        <el-button class="select_btn btn_100" @click="skipIsAdd(2)">编辑资料</el-button>
      </div>
    </div>
    <el-dialog
